...
<%@ page import="java.sql.*" %>
	...
	ResultSet rs=stmt.executeQuery("select * from blogusers where uname like '"+uname+"'");
	b=rs.next();
		...
		while(b)
		{
			...
			out.println("<td><br>"+rs.getString("uname")+"</td>");
			out.println("</tr>");
			out.println("<br><Br>");
			...
			out.println("<td><br>Password</td>");
				out.println("<td><br>"+rs.getString("password")+"</td>");
			out.println("</tr>");
	...
	out.println("<td><br>"+rs.getString("contact")+"</td>");
			out.println("</tr>");
			b=rs.next();
		}}
		  con.close();
