...
ps=con.prepareStatement("delete from inbox where f like '"+to1+"' and m like '"+msg1+"'");
ps.executeUpdate();
            ...
            <center>
             ...
             out.println("<a class=topics href=delpost.jsp?name="+uname+">DeletePosts</a><br>");
              out.println("<a class=topics href=delsent.jsp?name="+uname+">DelSentmsgs</a><br>");
				out.println("<form method=post action=delinbox.jsp?name="+uname+">");
				%>
				<br><br>
				To:
...
Statement stmt=con.createStatement();
	...
	if(b==false)
		...
		else
		{
			...
			out.println("<p class=blog-post-meta>"+ rs.getString("f")+"</p>");
